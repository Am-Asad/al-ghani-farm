...
import { FlockReportSummary as FlockReportSummaryType } from "@/types";
import {
  Calculator,
  DollarSign,
  Package,
...
type Props = {
  summary: FlockReportSummaryType & {
...
const FlockReportSummary = ({ summary, title, dateRange }: Props) => {
  const {
    totalTransactions,
...
export default FlockReportSummary;
