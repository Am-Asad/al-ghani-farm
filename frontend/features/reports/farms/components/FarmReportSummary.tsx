...
import { FarmReportSummary as FarmReportSummaryType } from "@/types";
import {
  Calculator,
  DollarSign,
  Package,
...
const FarmReportSummary = ({ summary, title, dateRange }: Props) => {
  const {
    totalTransactions,
...
export default FarmReportSummary;
