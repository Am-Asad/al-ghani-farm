...
import { BuyerReportSummary as BuyerReportSummaryType } from "@/types";
import {
  Calculator,
  DollarSign,
  Package,
...
type BuyerReportSummaryProps = {
  summary: BuyerReportSummaryType;
  title: string;
  dateRange?: {
    from: string;
    to: string;
...
const BuyerReportSummary = ({
  summary,
  title,
  dateRange,
}: BuyerReportSummaryProps) => {
  const {
    totalTransactions,
...
export default BuyerReportSummary;
