        ...
        <div className="rounded-lg border bg-card">
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                <div className="h-4 bg-muted rounded w-12 animate-pulse mb-2"></div>
...
export default ShedDetailsPageSkeleton;
